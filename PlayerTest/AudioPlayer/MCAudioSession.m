...
static void MCAudionSessionInterruptionListener(void *inClientData, UInt32 inInterruptionState)
{
...
{
    AudioSessionInitialize(NULL, NULL, MCAudionSessionInterruptionListener, (__bridge void *)self);
...
#pragma mark - public
- (BOOL)setActive:(BOOL)active error:(NSError * _Nullable __autoreleasing *)outError
{
...
- (BOOL)setActive:(BOOL)active options:(UInt32)options error:(NSError * _Nullable __autoreleasing *)outError
{
...
- (BOOL)setCategory:(UInt32)category error:(NSError * _Nullable __autoreleasing *)outError
{
